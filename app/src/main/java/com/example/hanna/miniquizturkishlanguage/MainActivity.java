...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView view3 = (WebView) findViewById(R.id.WebView3);
        String text3;
        ...
        WebView view4 = (WebView) findViewById(R.id.WebView4);
        String text4;
    ...
    public void submitAnswer(View view) {
        ...
        RadioButton RadioButton1 = (RadioButton) findViewById(R.id.radio_button_q1a1);
        boolean isChosenRadioButton1 = RadioButton1.isChecked();

        RadioButton RadioButton2 = (RadioButton) findViewById(R.id.radio_button_q1a2);
        boolean isChosenRadioButton2 = RadioButton2.isChecked();

        RadioButton RadioButton3 = (RadioButton) findViewById(R.id.radio_button_q1a3);
        boolean isChosenRadioButton3 = RadioButton3.isChecked();

        RadioButton RadioButton4 = (RadioButton) findViewById(R.id.radio_button_q2a1);
        boolean isChosenRadioButton4 = RadioButton4.isChecked();

        RadioButton RadioButton5 = (RadioButton) findViewById(R.id.radio_button_q2a2);
        boolean isChosenRadioButton5 = RadioButton5.isChecked();

        RadioButton RadioButton6 = (RadioButton) findViewById(R.id.radio_button_q2a3);
        boolean isChosenRadioButton6 = RadioButton6.isChecked();

        EditText questionCanswerView = (EditText)findViewById(R.id.textAnswerC);
        String answerC = questionCanswerView.getText().toString();

        EditText questionDanswerView = (EditText)findViewById(R.id.textAnswerD);
